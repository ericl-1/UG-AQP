...
A self-contained, browser-based tool for analysing multiple-choice exam results. No installation, no server, no data ever leaves your device.
...
No data is transmitted or stored anywhere. Files you upload are processed entirely within your browser session and are gone when you close the tab. Multiple users can access the tool simultaneously with complete isolation — no one can see anyone else's data.
